...
- Completed the project proposal using the peer feedback.
- Allocated tasks for work during reading week.

4. **_How do you feel about your progress?_** _(brief, free-form reflection)_

- I'm glad that the proposal is finished, as it required significant effort. Also, I'm satisfied with how tasks have been distributed evenly. Looking forward to the upcoming weeks.

5. **_What are you planning to do next week_**? _(give specific goals)_

- I plan to start my research on local network communications.
